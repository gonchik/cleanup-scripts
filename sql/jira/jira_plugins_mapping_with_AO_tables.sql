...
CREATE
TEMPORARY TABLE IF NOT EXISTS PLUGIN_INFO_STORAGE AS (
	SELECT *, upper(right(md5(pluginkey), 6)) as pluginhash
	FROM pluginstate
 );
...
values ('com.tempoplugin.tempo-core', 'Tempo core map', '013613'),
       ...
       ('com.riadalabs.jira.plugins.insight', 'Insight for Jira', '8542F1');
